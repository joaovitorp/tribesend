...
import { index as segmentsIndex, update as segmentsUpdate } from '@/routes/segments';
...
const submit = () => {
    form.put(segmentsUpdate({ segment: props.segment.id }).url);
};
</script>
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Atualize os dados do segmento</CardDescription>
                </CardHeader>
                <CardContent>
